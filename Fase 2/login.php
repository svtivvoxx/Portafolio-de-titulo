...
<body style="background-color: #fffaf1;">
    ...
    <div class="auth-container">
        <div id="login-section" class="auth-form">
            ...
            <div class="switch-form" style="margin-top: 15px; border-top: 1px solid #eee; padding-top: 10px;">
                <a href="index.php" style="color: #666; font-size: 0.8rem;">← Navegar por la web</a>
            </div>
        </div>
